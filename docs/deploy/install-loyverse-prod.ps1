...
# loyverse-sync under pm2. Ecosystem file, not `pm2 start npm -- start` - the
...
Write-Host "loyverse-sync redemarre via pm2 (pm2-startup) au reboot ; nginx via la tache planifiee 'nginx-posr' (au logon)."
